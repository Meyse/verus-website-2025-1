    ...
    >
      <div className="relative mx-auto flex h-[56px] w-full max-w-[1400px] items-center justify-between gap-3 px-4 md:h-[66px] md:px-8">
        ...
        <Button
          ...
          size="sm"
          className="h-8 shrink-0 gap-1.5 rounded-lg border-white/70 bg-transparent px-3 text-[13px] text-white hover:border-white hover:bg-white/10 hover:text-white dark:border-white dark:bg-transparent dark:hover:border-white dark:hover:bg-white/10 dark:hover:text-white"
        >
