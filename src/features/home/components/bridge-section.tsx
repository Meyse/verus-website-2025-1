        ...
        <div className="max-w-[760px]">
          ...
          <div className="mt-8 flex flex-col gap-4 md:flex-row">
            ...
            <a
              ...
              className="group flex h-[40px] items-center justify-center rounded-lg border border-gray-300 bg-white/90 px-6 text-[14px] font-medium text-gray-800 backdrop-blur-sm transition-all duration-300 hover:-translate-y-[1px] hover:border-gray-400 hover:bg-white hover:shadow-lg dark:border-blue-800/40 dark:bg-blue-950/40 dark:text-blue-300 dark:hover:border-blue-700/60 dark:hover:text-blue-200 md:h-[50px] md:text-[16px]"
            >
              See contract on Ethereum
              <ExternalLink className="ml-2 h-4 w-4 opacity-60 transition-opacity duration-300 group-hover:opacity-100" />
            </a>
          </div>
        </div>
      </div>
