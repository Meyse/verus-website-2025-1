      ...
      <div className="grid grid-cols-1 md:grid-cols-[minmax(0,1fr)_400px]">
        <aside className="order-1 min-w-0 border-b border-gray-200 bg-gray-50 p-6 dark:border-gray-800 dark:bg-gray-950 md:order-2 md:border-b-0 md:border-l md:p-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-[15px] leading-relaxed tracking-normal text-gray-600 dark:text-gray-300 md:text-[17px]">
              The more VRSC you stake, the higher your chances of finding
              blocks and earning rewards. There is no real minimum amount
              required to start staking.
            </p>
          </div>
        ...
        <StepCard
          number="1"
          title="Get your staking hardware"
          description="Possible with Windows, macOS, Linux, Raspberry Pi, Orange Pi, NUC, VM, you name it."
        >
          <p className="mb-3 text-[15px] leading-relaxed tracking-normal text-gray-600 dark:text-gray-300 md:text-[17px]">
            Recommended hardware requirements:
          </p>
          <div className="space-y-4">
            <CheckItem>64-bit OS and processor</CheckItem>
            <CheckItem>8GB memory plus 4GB swap</CheckItem>
            <CheckItem>50GB storage</CheckItem>
          </div>
        </StepCard>
        ...
        <StepCard
          ...
          description="You need a full node to participate in staking, so either Verus Desktop in native mode or CLI."
          className="!pb-0"
        >
        ...
        <StepCard
          number="3"
          title="Start staking with almost no barriers"
          description="Verus has extremely low-barrier staking."
        >
          <div className="space-y-4">
            <CheckItem>Almost no minimum requirement, starting from 0.00000001 VRSC</CheckItem>
            <CheckItem>No slashing</CheckItem>
            <CheckItem>No lock-up, so funds remain available</CheckItem>
          </div>
          <div className="mt-6 space-y-3 md:mt-8">
            <Notice>Keep your node online and in sync with the network.</Notice>
            <Notice>Always run the latest version.</Notice>
            <Notice>Funds stake after 150 block confirmations.</Notice>
          </div>
        </StepCard>
        ...
        <StepCard
          number="4"
          title="Earn more by running Bridgekeeper"
          description="Optionally, but recommended for the network. It makes cross-chain transfers between Verus and Ethereum possible."
        ...
        >
          <div className="space-y-2">
            ...
            >
              Run Bridgekeeper with Verus Desktop
            </TextLinkButton>
            <TextLinkButton
              ...
              icon={<FaYoutube className="h-5 w-5 text-[#FF0000]" />}
            >
              Run Bridgekeeper with CLI
            </TextLinkButton>
          </div>

          <div className="mt-6">
            <Notice>
              More Bridgekeeper nodes help cross-chain transfers complete
              faster.
            </Notice>
          </div>
        </StepCard>
